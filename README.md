...
- [ ] Mention two parts of Express that you learned about this week.
    I learned how to use it to create our backend server, and how to utilize it.

- [ ] Describe Middleware?
    Middleware are a set of written functions that help us pass objects/data through them to help us with our desired goal.

- [ ] Describe a Resource?
    A resource is the data inside of the API that can be manipulated with CRUD operations.

- [ ] What can the API return to help clients know if a request was successful?
    An API can return a status 200 message that indicates to clients that the request was successful.

- [ ] How can we partition our application into sub-applications?
    We can partition by creating separate folders that can link to others, and creating middleware. 
